...
import { validateLink, validateRecordedDate, validateTitle } from "@/lib/validation";

export const POV_LINKS_SELECT = "id,member_id,title,link,recorded_date,submitted_at,created_at";
...
export function buildPovLinkRow(payload = {}) {
  ...
  return { row: { title, link, recorded_date: recordedDate } };
}
